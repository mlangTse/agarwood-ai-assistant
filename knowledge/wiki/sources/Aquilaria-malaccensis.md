...
A. malaccensis 是沉香贸易中极重要的树种，资料涉及用途、威胁、保护和过度采伐问题。

## 资料边界

- 原始文件：`Aquilaria malaccensis.md`
- 该页是来源摘要，不替代原文。
